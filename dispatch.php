...
<section class="mt-3">
  <form action="<?php echo htmlentities($_SERVER["PHP_SELF"]) ?>" method="post">
    ...
    <div class="col-sm-8">
	  ...
	  <div class="form-group row">
    <label for="patrolCar" class="col-sm-4 col-form-label">Choose a Patrol Car(s)</label>
    <div class="col-sm-8">
    ...
    <div class="offset-sm-4 col-sm-8">
      <button type="submit" class="btn btn-primary" name="btnDispatch" id="submit">Dispatch Call</button>
		</div>
	  </div>
